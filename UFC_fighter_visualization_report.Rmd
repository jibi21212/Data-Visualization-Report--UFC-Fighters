...
ufc_data <- read.csv("datasets/chloropeth_dataset.csv")

fight_data_per_wc <- read.csv("datasets/boxplot_timeseries_stackedbars_dataset.csv")

gsp_data <- read.csv("datasets/lineplot_radarplot_dataset.csv")
